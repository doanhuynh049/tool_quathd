...
### USER INPUT ###
INPUT_DIR="./pdf_files"
OUTPUT_PDF="RENESAS_RCH3M3M3NE3D3V3UV3H_VideoCapture_UME_v3.1.0.pdf"
...
TITLE_NAME="R-Car Series Linux Interface Specification Device Driver Video Capture User’s Manual: Software"
